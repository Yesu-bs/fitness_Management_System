...
<title>Sign Up with FUNZONE</title>
			...
			<div class="container">
				<div class="signup-content">
					...
					<div class="signup-image">
						<figure>
							<img src="images/bala.jpg" alt="sing up image">
						</figure>
...
var status =document.getElementById("status").value;
 ...
 if(status=="invalidName"){
	swal("failed","please enter a name","error");
	}
 if(status=="invalidEmail"){
	swal("failed","please enter a email","error");
	}
...
if(status=="invalidMobile"){
 ...
 if(status=="invalidMobileLenth"){
	swal("failed","mobile number should be 10 digit","error");
	}
if(status=="success"){
